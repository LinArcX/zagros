...
linkObj() {
  echo "linkObj(): $1 --> $2 --> $3"
  ld -T $1 -melf_i386 $2 -o $3
}

compileCoverage() {
  echo "compileCoverage(): $1 --> $2"
...
menu () {
  ...
  case $selected in
    "build")
      ...
      compileNoStdLib "src/kernel.c" "build/obj/kernel.o"
      compileNoStdLib "src/util/strings.c" "build/obj/strings.o"
      compileNoStdLib "src/util/video_mmio.c" "build/obj/video_mmio.o"
      compileNoStdLib "src/util/globals.c" "build/obj/globals.o"
  
      echo ">>> linking .o files into .bin" 
      linkObj "src/linker.ld" "build/obj/*.o" "build/zagros.bin"
    ...
    "build(tests)")
      ...
      compileCoverage "src/util/globals.c" "unit_tests/build/globals.o"
      compileCoverage "src/util/hex.c" "unit_tests/build/hex.o"
      compileCoverage "src/util/int.c" "unit_tests/build/int.o"
      compileCoverage "src/util/float.c" "unit_tests/build/float.o"
      compileCoverage "src/util/strings.c" "unit_tests/build/strings.o"
      compileCoverage "src/util/logs.c" "unit_tests/build/logs.o"
      compileCoverage "src/util/video_mmio.c" "unit_tests/build/video_mmio.o"
   
      compileCoverage "unit_tests/ut_hex.c" "unit_tests/build/ut_hex.o"
      compileCoverage "unit_tests/ut_int.c" "unit_tests/build/ut_int.o"
      compileCoverage "unit_tests/ut_float.c" "unit_tests/build/ut_float.o"
      compileCoverage "unit_tests/ut_strings.c" "unit_tests/build/ut_string.o"
      compileCoverage "unit_tests/ut_logs.c" "unit_tests/build/ut_logs.o"
      compileCoverage "unit_tests/main.c" "unit_tests/build/main.o"
